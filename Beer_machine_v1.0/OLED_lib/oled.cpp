...
static const uint8_t oled_font6x8 [] PROGMEM = {
    ...
    0x00, 0x00, 0x00, 0x63, 0x00, 0x00, // ÂŚ
    0x00, 0x00, 0x41, 0x77, 0x08, 0x00, // }
    0x00, 0x08, 0x04, 0x08, 0x08, 0x04, // ~
    0x00, 0x3D, 0x40, 0x40, 0x20, 0x7D, // Ăź
    0x00, 0x3D, 0x40, 0x40, 0x40, 0x3D, // Ă
    0x00, 0x21, 0x54, 0x54, 0x54, 0x79, // Ă¤
    0x00, 0x7D, 0x12, 0x11, 0x12, 0x7D, // Ă
    0x00, 0x39, 0x44, 0x44, 0x44, 0x39, // Ăś
    0x00, 0x3D, 0x42, 0x42, 0x42, 0x3D, // Ă
    0x00, 0x02, 0x05, 0x02, 0x00, 0x00, // Â°
    0x00, 0x7E, 0x01, 0x49, 0x55, 0x73, // Ă
};
...
void OLED::i2c_start(uint8_t byte)
{
	Wire.beginTransmission(byte);
    OLED_I2C_DELAY;
}
...
void OLED::display()
{
    ...
    for (uint_fast8_t page = 0; page < pages; page++)
    {
        ...
        for (uint_fast8_t column = 0; column < width;)
        {
           i2c_start(i2c_address);
           i2c_send(0x40); // data
           do
