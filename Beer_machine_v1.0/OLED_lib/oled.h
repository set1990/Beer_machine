...
public:
    ...
    /** Supported text sizes. Normal=6x8 pixels, Double=12x16 pixels ONE HALF=6x16 */
    enum tSize { NORMAL_SIZE, DOUBLE_SIZE, ONE_HALF_SIZE };
    ...
    void draw_byte(uint_fast8_t x, uint_fast8_t y, uint8_t b, tColor color=WHITE);
